...
const AnnotationDetailSlider = function () {
  ...
  return (
      ...
      title={
        <div className="grid grid-cols-6 rounded-l items-center px-5">
          <div className="col-span-5">
            <p title={annotation.title} className="text-base font-medium text-gray-900 overflowWrap">
    ...
    >
      <div className="pl-5 pr-8 py-5 overflowWrap">{annotation.description}</div>
