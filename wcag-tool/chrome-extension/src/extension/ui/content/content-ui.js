...
const { SELECTED_CONTENT_ATTRIBUTE_NAME } = singlefile.helper
...
const { SINGLE_FILE_UI_ELEMENT_CLASS } = singlefile.helper
...
function unmarkSelection() {
  document
    ...
    .forEach((selectedContent) => selectedContent.removeAttribute(SELECTED_CONTENT_ATTRIBUTE_NAME))
}
